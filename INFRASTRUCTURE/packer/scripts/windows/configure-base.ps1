...
# Listener already exists (Packer connected through it). Skip delete/recreate —
# deleting the active listener terminates the WinRM session and the script dies
# before the listener can be recreated, leaving no listener for Packer to reconnect.
