# =============================================================================
# Packer Template: Windows 11
# =============================================================================
# Builds a Proxmox VM template for Windows 11 with:
...
variable "iso_file" {
  type        = string
  description = "Proxmox storage path to Windows 11 ISO"
}
...
source "proxmox-iso" "windows-11" {
  ...
  additional_iso_files {
    device           = "sata2"
    cd_files         = ["../http/autounattend/win11/autounattend.xml"]
    cd_label         = "OEMDRV"
    iso_storage_pool = var.proxmox_storage_pool
  }

  # Hardware - UEFI boot for Windows 11 (TPM bypass via LabConfig registry)
  machine  = "q35"
  memory   = 4096
  cores    = 2
  sockets  = 1
