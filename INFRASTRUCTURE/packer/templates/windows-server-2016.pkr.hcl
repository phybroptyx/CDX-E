# =============================================================================
# Packer Template: Windows Server 2016
# =============================================================================
# Builds a Proxmox VM template for Windows Server 2016 with:
...
variable "iso_file" {
  type        = string
  description = "Proxmox storage path to Windows Server 2016 ISO"
}
...
variable "template_name" {
  type    = string
  default = "cdx-win2016-base"
}

variable "autounattend_file" {
  type    = string
  default = "../http/autounattend/win2016/autounattend.xml"
}
...
source "proxmox-iso" "windows-server-2016" {
  ...
  sockets  = 1
  cpu_type = "host"
  os       = "win10"  # Proxmox OS type for Server 2016
