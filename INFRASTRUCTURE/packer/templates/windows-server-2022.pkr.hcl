# =============================================================================
# Packer Template: Windows Server 2022
# =============================================================================
# Builds a Proxmox VM template for Windows Server 2022 with:
...
variable "iso_file" {
  type        = string
  description = "Proxmox storage path to Windows Server 2022 ISO"
}
...
variable "template_name" {
  type    = string
  default = "cdx-win2022-base"
}

variable "autounattend_file" {
  type    = string
  default = "../http/autounattend/win2022/autounattend.xml"
}
...
source "proxmox-iso" "windows-server-2022" {
  ...
  sockets  = 1
  cpu_type = "host"
  os       = "win11"  # Proxmox OS type for Server 2022
