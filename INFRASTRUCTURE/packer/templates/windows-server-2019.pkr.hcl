# =============================================================================
# Packer Template: Windows Server 2019
# =============================================================================
# Builds a Proxmox VM template for Windows Server 2019 with:
...
variable "iso_file" {
  type        = string
  description = "Proxmox storage path to Windows Server 2019 ISO"
}
...
variable "template_name" {
  type    = string
  default = "cdx-win2019-base"
}

variable "autounattend_file" {
  type    = string
  default = "../http/autounattend/win2019/autounattend.xml"
}
...
source "proxmox-iso" "windows-server-2019" {
  ...
  sockets  = 1
  cpu_type = "host"
  os       = "win10"  # Proxmox OS type for Server 2019
